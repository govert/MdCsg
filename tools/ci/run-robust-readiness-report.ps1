...
Write-Host "READINESS_COLLINEAR_GUARD_CONTRACT=PASS"
Write-Host "READINESS_LOCAL_RETRIANGULATION_CONTRACT=PASS"
Write-Host "READINESS_SHOWCASE_CLOSURE_MODE_CONTRACT=PASS"
Write-Host "READINESS_SHOWCASE_ISSUE_SUMMARY_CONTRACT=PASS"
